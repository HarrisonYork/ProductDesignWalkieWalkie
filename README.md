...
## FRS Frequencies
SA818s module transmits at 1 W at high power. Some FRS frequencies allow only 0.5 W, others up to 2 W. To use the 25 KHz bandwidth offered by the module, can use the following 8 channels:
|Ch#|   MHz    |
|---|----------|
| 1 | 462.5500 |
| 2 | 462.5750 |
